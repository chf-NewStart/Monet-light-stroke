...
- Build foliage and flowers as connected color masses before adding comma strokes, hooks, flicks, and accents. Use broad and medium overlapping marks to suggest collective growth and movement; never translate every leaf, petal, or blossom into a separate dot.
...
- Foliage reads first as overlapping tree or shrub masses and only later as selective comma-like growth marks. Reject pointillist blossom fields, thousands of isolated leaf dots, and equal tiny stippling across foreground and distance.
